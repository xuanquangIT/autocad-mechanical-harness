...
def register(mcp: FastMCP, context: ServerContext) -> None:
    ...
    @mcp.tool()
    def cad_document_inspect(document_id: str | None = None) -> dict[str, Any]:
    ...
    @mcp.tool()
    def cad_selection_inspect(document_id: str, max_entities: int = 200) -> dict[str, Any]:
    ...
    @mcp.tool()
    def cad_feature_catalog_search(query: str = "") -> dict[str, Any]:
