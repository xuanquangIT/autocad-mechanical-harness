...
public sealed class PipeRequestProcessorTests
{
    ...
    public static TheoryData<byte[], string> RejectedPayloads => new()
    {
        { Encoding.UTF8.GetBytes("{"), "INVALID_FEATURE_PARAMETERS" },
        {
            Encoding.UTF8.GetBytes(
                """{"schema_version":"1.13","method":"does_not_exist","request_id":"unknown-1","params":{}}"""),
            "INVALID_FEATURE_PARAMETERS"
        },
        {
            Encoding.UTF8.GetBytes(
                """{"schema_version":"1.13","method":"status","request_id":"missing-1"}"""),
            "INVALID_FEATURE_PARAMETERS"
        },
        {
            Encoding.UTF8.GetBytes(
                """{"schema_version":"1.13","method":"status","request_id":"extra-1","params":{},"unexpected":true}"""),
            "INVALID_FEATURE_PARAMETERS"
        },
        {
            Encoding.UTF8.GetBytes(
        ...
        {
            Encoding.UTF8.GetBytes(
                """{"schema_version":"1.13","method":"status","request_id":"depth-1","params":{"a":{"b":{"c":{"d":1}}}}}"""),
            "INVALID_FEATURE_PARAMETERS"
        },
    };
    ...
    public async Task DomainErrorResultPassesThroughTypedFieldsWithoutOwningEnvelope(string status)
    {
        ...
        Assert.Equal("1.13", Text(response, "schema_version"));
        ...
        int maximumRequestBytes)
    {
        switch (caseKind)
        {
            ...
            case Property14CaseKind.ExcessiveDepth:
                {
                    ...
                    return Encoding.UTF8.GetBytes(
                        $"{{\"schema_version\":\"1.13\",\"method\":\"status\"," +
            ...
            case Property14CaseKind.InvalidEnvelope:
                ...
                {
                    0 => $"{{\"schema_version\":\"1.13\",\"method\":\"status\",\"request_id\":\"{requestId}\"}}",
                    1 => $"{{\"schema_version\":\"1.13\",\"method\":\"arbitrary\",\"request_id\":\"{requestId}\",\"params\":{{}}}}",
                    2 => "{\"schema_version\":\"1.13\",\"method\":\"status\",\"request_id\":\"\",\"params\":{}}",
                    3 => $"{{\"schema_version\":\"1.13\",\"method\":\"status\",\"request_id\":\"{requestId}\",\"params\":{{}},\"extra\":true}}",
                    4 => $"{{\"schema_version\":\"1.13\",\"method\":\"status\",\"request_id\":\"{requestId}\",\"params\":[]}}",
                    _ => $"{{\"schema_version\":\"1.13\",\"method\":\"status\",\"request_id\":\"{requestId}\",\"request_id\":\"duplicate\",\"params\":{{}}}}",
                });
